                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <a href="addBlog.php" class="addtotable">اضافه بوست</a>
                                </div>
                                <table class=" table ">
                                    <tr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p><?php echo $Blogt["title_en"] ?></p>
                                            </td>
                                      
                                            <td>
                                                <p><?php echo $Blogt["description_en"] ?></p>
                                            </td>
                                            ...
                                            <td>
                                                <img src="../../uploads/blogs/<?php echo $Blogt["img"];  ?>" alt="" >
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php printf('%s?id=%s', 'BlogDetail.php',  $Blogt['id']); ?>">
