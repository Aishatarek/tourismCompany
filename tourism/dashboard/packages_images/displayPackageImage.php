                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <a href="addPackageImage2.php" class="addtotable">اضافه منتج</a>
                                </div>
                                ...
                                <table class=" table ">
                                    ...
                                    <?php
                                    foreach ($PackageImage->getData() as $PackageImaget) :
                                    ?>
                                        <tr class="thing">
                             
                                            <td>
                                                <p><?php echo $PackageImaget["title"] ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo $PackageImaget["describtion"] ?> </p>
                                            </td>
                                            ...
                                            <td>
                                                <form method="post">
                                                    ...
                                                    <input type="hidden" value="<?php echo $PackageImaget["id"] ?>" name="item_id">
                                                    <button name="deleteItem_PackageImage" class="btn btn-outline-danger" type="submit"><i class="fas fa-trash"></i></button>

                                                </form>
                                                <a href="<?php printf('%s?id=%s', 'updatePackageImage.php',  $PackageImaget['id']); ?>">
