                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <a href="addBlogDesc2.php" class="addtotable">اضافه منتج</a>
                                </div>
                                ...
                                <table class=" table ">
                                    ...
                                    ?>
                                        <tr class="thing">
                                            ...
                                            <td>
                                                <p><?php echo $BlogDesct["title_en"] ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo $BlogDesct["describtion_en"] ?> </p>
                                            </td>
                                            <td>
                                                <p><?php echo $BlogDesct["title_ar"] ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo $BlogDesct["describtion_ar"] ?> </p>
                                            </td>
                            
                                            <td>
                                                <form method="post">

                                                    <input type="hidden" value="<?php echo $BlogDesct["id"] ?>" name="item_id">
                                                    <button name="deleteItem_BlogDesc" class="btn btn-outline-danger" type="submit"><i class="fas fa-trash"></i></button>

                                                </form>
                                                <a href="<?php printf('%s?id=%s', 'updateBlogDesc.php',  $BlogDesct['id']); ?>">
