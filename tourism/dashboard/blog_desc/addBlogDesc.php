...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        foreach ($Blog->getLastData() as $ques) {
            $blog_id = $ques['id'];
        }
        $BlogDesc->addBlogDesc($title_en, $description_en, $title_ar, $description_ar, $blog_id);
    }
}
include("../header.php");
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="" method="POST" class="login-email" enctype="multipart/form-data">
                                    <p style="font-size: 2rem; font-weight: 800;">اضافه تفاصيل</p>
                                    ...
                                    <br>
                                    <div class="input-group">
                                        <button name="submit" class="btn addtotable">اضافه تفاصيل</button>
                                    </div>
                                </form>
                            </div>
                        </div>
