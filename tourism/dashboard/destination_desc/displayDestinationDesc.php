                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <a href="addDestinationDesc2.php" class="addtotable">اضافه منتج</a>
                                </div>
                                ...
                                <table class=" table ">
                                    ...
                                    ?>
                                        <tr class="thing">
                                            ...
                                            <td>
                                                <p><?php echo $DestinationDesct["title"] ?></p>
                                            </td>
                                            <td>
                                                <p><?php echo $DestinationDesct["describtion"] ?> </p>
                                            </td>
                                            ...
                                            <td>
                                                <form method="post">
                                                    ...
                                                    <input type="hidden" value="<?php echo $DestinationDesct["id"] ?>" name="item_id">
                                                    <button name="deleteItem_DestinationDesc" class="btn btn-outline-danger" type="submit"><i class="fas fa-trash"></i></button>

                                                </form>
                                                <a href="<?php printf('%s?id=%s', 'updateDestinationDesc.php',  $DestinationDesct['id']); ?>">
