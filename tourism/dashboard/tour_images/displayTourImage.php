...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['deleteItem_TourImage'])) {
        $TourImage->deleteTourImage($_POST['item_id']);
    }
}
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center">
                                    <a href="addTourImage2.php" class="addtotable">اضافه صوره</a>
                                </div>
                                ...
                                <table class=" table ">
                                    ...
                                    <?php
                                    foreach ($TourImage->getData() as $TourImaget) :
                                    ?>
                                        <tr class="thing">
                             
                                            <td>
                                                <img src="../../uploads/TourImages/<?php echo $TourImaget["img"] ?>" alt="">
                                            </td>
                                            ...
                                            <td>
                                                <form method="post">
                                                    ...
                                                    <input type="hidden" value="<?php echo $TourImaget["id"] ?>" name="item_id">
                                                    <button name="deleteItem_TourImage" class="btn btn-outline-danger" type="submit"><i class="fas fa-trash"></i></button>

                                                </form>
                                                <a href="<?php printf('%s?id=%s', 'updateTourImage.php',  $TourImaget['id']); ?>">
